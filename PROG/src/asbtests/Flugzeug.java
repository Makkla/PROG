...
public class Flugzeug {
    ...
    public double getReichweite() {
        ...
        if (verbrauch != 0) {
            ...
            System.out.println("Dein Flugzeug verbraucht also nix? Du hast gerade die Welt gerettet!! Gl�ckwunsch!!");
        }
    ...
    public static void main(String[] args) {
        ...
        while (!albatros.input.equalsIgnoreCase("q")) {
            ...
            if (albatros.input.equalsIgnoreCase("t")) {
                System.out.println("Wieviel Liter m�chtest du tanken? (Nur Zahlen bitte...sei nett ;)");
                System.out.println(">>");
